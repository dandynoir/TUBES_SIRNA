...
<head>
    ...
    <title>SIRNA | Registrasi Staf</title>
    ...
    <style>
        /* CSS styles tetap sama dengan halaman login untuk konsistensi */
        ...
        .error-message { background-color: rgba(239, 68, 68, 0.2); border: 1px solid #ef4444; color: #f87171; padding: 0.75rem; border-radius: 0.375rem; text-align: center; margin-bottom: 1.5rem; animation: fade-in-down 0.5s ease-out; }
    </style>
</head>
<body class="text-white">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <div class="login-container flex flex-col items-center">
            <div class="mb-12">
                <img id="logo-image" src="" alt="Logo SIRNA" class="login-logo">
            </div>
            ...
            <div class="w-full max-w-sm">
                <?php if(isset($_GET['error'])): ?>
                    <div class="error-message">
                        <?php 
                            if($_GET['error'] == 'passwordmismatch') echo 'Password dan konfirmasi password tidak cocok.';
                            else if($_GET['error'] == 'usernameexists') echo 'Username sudah digunakan, silakan pilih yang lain.';
                ...
                <form id="registerForm" action="proses_register.php" method="POST" class="space-y-4">
                    <div class="input-container">
                        ...
                        <label for="role" class="input-label">Daftar Sebagai</label>
                    ...
                    <div class="input-container">
                        <input type="password" id="confirm_password" name="confirm_password" class="input-field" placeholder=" " required>
                ...
                <a href="index.php" class="block text-center mt-6 text-orange-400 hover:underline">Sudah punya akun? Login di sini</a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const logoPath = '../assets/images/sirna.logo.png';
        logoImage.src = logoPath;
        logoImage.onerror = function() {
            this.src = 'https://placehold.co/320x80/181818/ffffff?text=SIRNA&font=playfairdisplay';
        };
    </script>
